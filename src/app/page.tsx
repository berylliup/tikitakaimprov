  ...
  TikiTaka Impro
    ...
    <div className="flex shrink-0 items-center gap-3 sm:gap-4">
      ...
      <a
        ...
        target="_blank"
        rel="noreferrer"
        className="inline-flex min-h-[56px] min-w-[120px] items-center justify-center rounded-full bg-[#FFCB00] px-6 py-2 text-center text-base font-bold hover:opacity-90 transition sm:min-h-0 sm:min-w-0 sm:px-5"
      >
        Bilet Al
      </a>
    </div>
